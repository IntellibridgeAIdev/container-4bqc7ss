...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4bqc7ss.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4bqc7ss.containers.anotherwebservice.com/
...
```
git clone git@github.com:IntellibridgeAIdev/container-4bqc7ss.git
cd container-4bqc7ss
```
...
```
docker attach container-4bqc7ss
```
